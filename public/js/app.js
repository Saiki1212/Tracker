...
(function () {
  const NAV = [
    ...
    { route: 'tasks', label: 'Tasks', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>' },
  ...
  const BOTTOM = ['dashboard', 'tasks', 'applications', 'interviews'];
  ...
  function bindKeyboard() {
    ...
    document.addEventListener('keydown', (e) => {
      ...
      if (g) {
        const map = { d: 'dashboard', a: 'applications', i: 'interviews', p: 'projects', r: 'resumes', l: 'learning', w: 'weekly', n: 'notes', t: 'tasks', y: 'analytics', s: 'settings' };
  ...
  function registerRoutes() {
    [
      ...
      pages.tasks, pages.analytics, pages.settings,
